...
//Texture loading
    ...
    unsigned int texture2=loadTexture("images/grass.png", GL_CLAMP_TO_EDGE);
...
//Weed
    //Switch to weed texture
        ...
        //Weed world transformation
            model=glm::mat4(1.0f);
            model=glm::translate(model, weedPositions[n]);
            shader.setMat4("model", model);
        //Render weeds
            glDrawArrays(GL_TRIANGLES, 0, 6);
        }
