...
/**...                                      */
/**Texture loading...                       */
    unsigned int bricks=loadTexture("images/bricks2.jpg", GL_REPEAT);
    unsigned int bricksNormal=loadTexture("images/bricks2_normal.jpg", GL_REPEAT);
    unsigned int bricksDisplace=loadTexture("images/bricks2_disp.jpg", GL_REPEAT);
/**...                                      */
/**Light properties...                      */
...
/**...                                      */
    ...
    //2. Render plane.
        ...
        glBindTexture(GL_TEXTURE_2D, bricksDisplace);
        renderPlane(planeVAO);
    //3. Render lamp as well.
        lampShader.use();
        renderCube(cubeVAO);
