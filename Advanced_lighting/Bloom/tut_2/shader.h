...
class Shader{
    ...
    private:
    unsigned int createShader(const char *shaderCode, GLenum dftype, const char *type, const char *path=nullptr);
    void checkCompileErrors(unsigned int shader, std::string type, const char *path=nullptr);
};
