...
int main()
{
    ...
    Image img0=loadImage("images/container2.png");
    Image img1=loadImage("images/lighting_maps_specular_color.png");
    Vector2u measures0=img0.getSize();
...
//Texture loading, diffuse map
    ...
    char *data0=(char*)img0.getPixelsPtr();
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, measures0.x, measures0.y, 0, GL_RGBA, GL_UNSIGNED_BYTE, data0);
