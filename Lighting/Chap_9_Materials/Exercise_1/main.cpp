...
glm::vec3 lampPos(0.5f, 0.2f, 2.0f);
...
//Fragment shader uniforms
    ...
    int mat=ruby;
    cubeShader.use();
    cubeShader.setVec3("material.ambient", matval[mat*col+0], matval[mat*col+1], matval[mat*col+2]);
    cubeShader.setVec3("material.diffuse", matval[mat*col+3], matval[mat*col+4], matval[mat*col+5]);
    cubeShader.setVec3("material.specular", matval[mat*col+6], matval[mat*col+7], matval[mat*col+8]);
    cubeShader.setFloat("material.shininess", matval[mat*col+9]*128.f);
    /*
...
//Last settings
    ...
    while(run){
        ...
        lightColor.y=cos(currentFrame);//*0.7f;
